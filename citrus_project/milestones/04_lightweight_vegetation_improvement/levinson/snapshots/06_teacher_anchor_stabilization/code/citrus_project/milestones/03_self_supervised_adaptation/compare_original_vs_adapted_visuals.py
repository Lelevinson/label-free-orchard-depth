...
def render_comparison(
    ...
    fig.suptitle(
        ...
        f"{metric_label(baseline_row, baseline_label)} | "
        f"{metric_label(row, adapted_label)}",
        fontsize=13,
    )
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--baseline_label", default="Original")
